...
Hexadecimal [16-Bits]
                             ...
                             11 
                             12 
                             13 ;k_max_num_enemy = (n_enem)    ;;numero maximo de enemigos que puedo tener
                     000D    14 k_enemy_size = enemy_data0_size      ;;tamaño del enemigo
                             15 
   774F                      16 enemy_vector:
   774F                      17 DefineEnemy enemy_data0, 0x00, 0x00, 0xFF, 0x00, 0x06, 0x10, _robot_sp_0, 0x00, 0x06, 0x06, -1, -1
   0000                       1 enemy_data0:
   774F 00 00                 2    .db   0x00, 0x00       ;;X, Y
   7751 FF 00                 3    .db   0xFF, 0x00     ;;VX, VY
   7753 06 10                 4    .db   0x06, 0x10       ;;W, H
   7755 D8 6A                 5    .dw   _robot_sp_0      ;;Puntero al sprite
   7757 00                    6    .db   0x00        ;;Enemy life
   7758 06                    7    .db   0x06        ;;enemy slow
   7759 06                    8    .db   0x06        ;;enemy slow
   775A FF                    9    .db 	 -1
   775B FF                   10    .db   -1
                     000D    11    enemy_data0_size = . - enemy_data0
   775C                      18 DefineEnemy enemy_data1, 0x00, 0x00, 0xFF, 0x00, 0x06, 0x10, _robot_sp_0, 0x00, 0x06, 0x06, -1, 0
   000D                       1 enemy_data1:
   775C 00 00                 2    .db   0x00, 0x00       ;;X, Y
   775E FF 00                 3    .db   0xFF, 0x00     ;;VX, VY
   7760 06 10                 4    .db   0x06, 0x10       ;;W, H
   7762 D8 6A                 5    .dw   _robot_sp_0      ;;Puntero al sprite
   7764 00                    6    .db   0x00        ;;Enemy life
   7765 06                    7    .db   0x06        ;;enemy slow
   7766 06                    8    .db   0x06        ;;enemy slow
   7767 FF                    9    .db 	 -1
   7768 00                   10    .db   0
                     000D    11    enemy_data1_size = . - enemy_data1
   7769                      19 DefineEnemy enemy_data2, 0x00, 0x00, 0xFF, 0x00, 0x06, 0x10, _robot_sp_0, 0x00, 0x06, 0x06, -1, 0
   001A                       1 enemy_data2:
   7769 00 00                 2    .db   0x00, 0x00       ;;X, Y
   776B FF 00                 3    .db   0xFF, 0x00     ;;VX, VY
   776D 06 10                 4    .db   0x06, 0x10       ;;W, H
   776F D8 6A                 5    .dw   _robot_sp_0      ;;Puntero al sprite
   7771 00                    6    .db   0x00        ;;Enemy life
   7772 06                    7    .db   0x06        ;;enemy slow
   7773 06                    8    .db   0x06        ;;enemy slow
   7774 FF                    9    .db 	 -1
   7775 00                   10    .db   0
                     000D    11    enemy_data2_size = . - enemy_data2
   7776                      20 DefineEnemy enemy_data3, 0x00, 0x00, 0xFF, 0x00, 0x06, 0x10, _robot_sp_0, 0x00, 0x06, 0x06, -1, 0
   0027                       1 enemy_data3:
   7776 00 00                 2    .db   0x00, 0x00       ;;X, Y
   7778 FF 00                 3    .db   0xFF, 0x00     ;;VX, VY
   777A 06 10                 4    .db   0x06, 0x10       ;;W, H
   777C D8 6A                 5    .dw   _robot_sp_0      ;;Puntero al sprite
   777E 00                    6    .db   0x00        ;;Enemy life
   777F 06                    7    .db   0x06        ;;enemy slow
   7780 06                    8    .db   0x06        ;;enemy slow
   7781 FF                    9    .db 	 -1
   7782 00                   10    .db   0
                     000D    11    enemy_data3_size = . - enemy_data3
   7783                      21 DefineEnemy enemy_data4, 0x00, 0x00, 0xFF, 0x00, 0x06, 0x10, _robot_sp_0, 0x00, 0x06, 0x06, -1, 0
...
Hexadecimal [16-Bits]
   ...
   0034                       1 enemy_data4:
   7783 00 00                 2    .db   0x00, 0x00       ;;X, Y
   7785 FF 00                 3    .db   0xFF, 0x00     ;;VX, VY
   7787 06 10                 4    .db   0x06, 0x10       ;;W, H
   7789 D8 6A                 5    .dw   _robot_sp_0      ;;Puntero al sprite
   778B 00                    6    .db   0x00        ;;Enemy life
   778C 06                    7    .db   0x06        ;;enemy slow
   778D 06                    8    .db   0x06        ;;enemy slow
   778E FF                    9    .db 	 -1
   778F 00                   10    .db   0
                     000D    11    enemy_data4_size = . - enemy_data4
                             22 
   7790 01                   23 init_enemy:     .db #1            ;; pinta por primera vez todas
   7791 64                   24 pos_y_en:               .db #100
   7792 64                   25 pos_x:               .db #100
                             26 
                             27 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             28 ;;    MOVER ENTIDAD
                             29 ;; Destruye 
   ...
   7793                      32 enemy_move:
                             33    
                             34    ;;call  check_platform_enemy
   7793 FD 7E 02      [19]   35    ld    a,    en_vx(iy)    
   7796 FE 01         [ 7]   36    cp    #0x01
   7798 CA B7 77      [10]   37    jp    z,    go_moveright
                             38 
   779B FD 7E 02      [19]   39    ld    a,    en_vx(iy)    
   779E FE FF         [ 7]   40    cp    #0xFF
   77A0 CA A3 77      [10]   41    jp    z,    go_moveleft
                             42 
   77A3                      43    go_moveleft:
   77A3 21 38 6B      [10]   44       ld    hl, #_robot_sp_1    
   77A6 FD 75 06      [19]   45       ld    en_sp_l(iy), l
   77A9 FD 74 07      [19]   46       ld    en_sp_h(iy), h    
                             47 
   77AC FD 7E 00      [19]   48       ld    a,    en_x(iy)    
   77AF FE 00         [ 7]   49       cp    #0x00
   77B1 CA E9 77      [10]   50       jp    z,    no_moveX
   77B4 C2 CB 77      [10]   51       jp    nz,   move
                             52 
   77B7                      53    go_moveright:
   77B7 21 D8 6A      [10]   54       ld    hl, #_robot_sp_0      
   77BA FD 75 06      [19]   55       ld    en_sp_l(iy), l
   77BD FD 74 07      [19]   56       ld    en_sp_h(iy), h 
                             57 
   77C0 FD 7E 00      [19]   58       ld    a,    en_x(iy) 
   77C3 FD 86 04      [19]   59       add   en_w(iy)   
   77C6 FE 50         [ 7]   60       cp    #0x50
   77C8 CA E9 77      [10]   61       jp    z,    no_moveX
                             62 
   77CB                      63    move:
   77CB FD 7E 00      [19]   64       ld    a,    en_x(iy)    ;; Cargo la posicion X en A
   77CE FD 86 02      [19]   65       add   en_vx(iy)       ;; Le sumo la VX
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 60.
Hexadecimal [16-Bits]



   77D1 FD 77 00      [19]   66       ld    en_x(iy),   a     ;; Actualizo la posicion
                             67 
   77D4 CD F4 85      [17]   68       call  check_platform_enemy
                             69       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             70       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   77D7 FD 7E 0B      [19]   71       ld    a,    11(iy)
   77DA FE 01         [ 7]   72       cp    #1             ;; Si llega al final no actualiza
   77DC CA E8 77      [10]   73       jp    z,    end_move
   77DF FD 7E 00      [19]   74       ld    a,    en_x(iy)
   77E2 FD 96 02      [19]   75       sub   en_vx(iy)
   77E5 FD 77 00      [19]   76       ld    en_x(iy),   a
                             77       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             78       ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   77E8                      79       end_move:
   77E8 C9            [10]   80       ret
   ...
   77E9                      83    no_moveX:
                             84 
   77E9 FD 7E 01      [19]   85    ld    a,  en_y(iy)
   77EC FD 86 03      [19]   86    add   en_vy(iy)
   77EF FD 77 01      [19]   87    ld    en_y(iy), a
                             88 
   77F2 C9            [10]   89    ret
                             90 
                             91 
   77F3                      92 enemy_interaction:
                             93 
   77F3 3A BC 7C      [13]   94    ld    a, (n_enem)                      ;; NUMERO DE Enemigos
   77F6 FE 00         [ 7]   95    cp    #0
   77F8 C8            [11]   96    ret    z
   77F9 3A BC 7C      [13]   97    ld    a, (n_enem)                      ;; NUMERO DE Enemigos
   77FC FD 21 4F 77   [14]   98    ld    iy, #enemy_vector          ;; VECTOR DE Enemigos
                             99 
   7800                     100 bucle:
                            101 
   7800 08            [ 4]  102    ex    af, af'                    ;; INTERCAMBIO AF por AF'
                            103 
                            104 ;////////////////////////////////////////////////////////////////////
                            105 ;////////////////////////////////////////////////////////////////////
                            106 ;////////////////////////////////////////////////////////////////////
                            107 
   7801 3A 90 77      [13]  108    ld    a, (init_enemy)
   7804 FE 01         [ 7]  109    cp    #1                         ;; INICIALIZA EL ENEMIGO
                            110 
   7806 CA 57 78      [10]  111    jp    z, inicializacion_enemy
                            112 
                            113 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; SI EL ENEMIGO YA ESTA MUERTO
                            114                                     ;; AL SIGUIENTE
   7809 FD 7E 08      [19]  115    ld    a,    en_life(iy)
   780C FE 00         [ 7]  116    cp    #0
   780E CA 65 78      [10]  117    jp    z,    next_enemy
                            118 
                            119 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; SI EL ENEMIGO CHOCA CON EL HERO
                            120 
...
Hexadecimal [16-Bits]
   ...
   7811 CD F4 78      [17]  121    call enemy_touch_hero
                            122 
                            123 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; COMPROBAMOS SI TENEMOS DISPARO
                            124 
   7814 3A 0F 76      [13]  125    ld    a,    (hero_shot)
   7817 FE FF         [ 7]  126    cp    #-1
                            127 
   7819 CA 47 78      [10]  128    jp    z,    not_colision
                            129 
                            130 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; COMPROBACION SI LE DAMOS A UN ENEMIGO
   781C DD 21 07 76   [14]  131    ld    ix,    #shot_data
   7820 CD 97 74      [17]  132    call  colision_check
   7823 3A 95 74      [13]  133    ld    a,    (colision)
   7826 FE 01         [ 7]  134    cp    #1
   7828 C2 47 78      [10]  135    jp    nz,   not_colision         ;; Si no hay colision
                            136 
   782B CD 58 79      [17]  137    call  quita_vida_enemigo
                            138 
   782E 3E FF         [ 7]  139    ld    a, #-1                     ;; para de disparar
   7830 32 0F 76      [13]  140    ld    (hero_shot), a
   7833 3A 12 76      [13]  141    ld    a,    (munition)
   7836 CD A8 83      [17]  142    call draw_numbers
                            143 
   7839 CD 64 7B      [17]  144    call  hero_dispara
                            145 
                            146    ;; INTENTAMOS CAMBIO DE COLOR EN CASO DE COLISION (3 DISPAROS)
                            147 
                            148 
   783C FD 7E 08      [19]  149    ld    a,    en_life(iy)
   783F FE 00         [ 7]  150    cp    #0
   7841 F2 44 78      [10]  151    jp    p,   aun_no_muere
                            152 
   7844                     153    aun_no_muere:
   7844 CD 15 77      [17]  154       call  s_background
                            155 
   7847                     156    not_colision:
                            157 
                            158 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; PINTA Y LIMPIA CADA ENEMIGO
   7847 FD 7E 08      [19]  159    ld    a, en_life(iy)
   784A FE 00         [ 7]  160    cp    #0
                            161 
   784C CA 62 78      [10]  162    jp    z, enemy_die               ;; NO TIENE VIDA, DEJO DE PINTAR
                            163 
   784F CD 91 78      [17]  164       call  enemy_see_hero
   7852 FE 0A         [ 7]  165       cp #10
   7854 C2 5A 78      [10]  166       jp nz, no_move_no_draw
                            167 
   7857                     168       inicializacion_enemy:           ;; inicializa los enemigos
   7857 CD 74 78      [17]  169          call  enemy_draw
                            170 
   785A                     171       no_move_no_draw:
                            172 
   785A FD 7E 08      [19]  173    ld    a, en_life(iy)
   785D FE 00         [ 7]  174    cp    #0
   785F C2 65 78      [10]  175    jp    nz,   next_enemy           ;; EVITO EL ULTIMO LIMPIAR
...
Hexadecimal [16-Bits]
                            ...
                            176 
   7862                     177    enemy_die:
   7862 CD 74 78      [17]  178       call  enemy_draw             ;; lo limpia por ultima vez
                            179       ;call  s_background
   7865                     180    next_enemy:
                            181 
                            182 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            183 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; FIN DE COMPORTAMIENTO ENEMIGO
                            184    
                            185 
   7865 08            [ 4]  186       ex    af, af'                    ;; VUELVO A CAMBIAR AF por AF'
   7866 01 0D 00      [10]  187       ld    bc, #k_enemy_size           ;; AUMENTO POSICION ARRAY
   7869 FD 09         [15]  188       add   iy, bc                     ;; LA CARGO EN IY
                            189 
   786B 3D            [ 4]  190       dec   a                          ;; DECREMENTO LA CANTIDAD DEL ARRAY
   786C 20 92         [12]  191       jr    nz, bucle                    ;; SI NO ES CERO BUCLE
                            192 
   786E 3E FF         [ 7]  193       ld    a,    #-1
   7870 32 90 77      [13]  194       ld    (init_enemy), a
   7873 C9            [10]  195    ret  
                            196 
   7874                     197 enemy_draw:
   7874 11 00 C0      [10]  198   ld    de, #0xC000         ;; Comienzo de memoria de video
   7877 FD 4E 00      [19]  199   ld    c, en_x(iy)          ;; Entidad X
   787A FD 46 01      [19]  200   ld    b, en_y(iy)          ;; Entidad Y
   787D CD 38 8A      [17]  201   call  cpct_getScreenPtr_asm  ;; Posicionar en pantalla
                            202 
                            203   ;;;HL -> Memoria de video
                            204 
   7880 EB            [ 4]  205   ex    de, hl         ;; Cambio lo de HL a DE
   7881 FD 6E 06      [19]  206   ld    l, en_sp_l(iy)
   7884 FD 66 07      [19]  207   ld    h, en_sp_h(iy)
                            208   ;;;ld    hl, #_hero_sp_0  
   7887 FD 4E 05      [19]  209   ld    c,  en_h(iy)     ;; Alto
   788A FD 46 04      [19]  210   ld    b,  en_w(iy)     ;; Ancho
                            211 
                            212 
   788D CD ED 89      [17]  213    call cpct_drawSpriteBlended_asm
                            214 
   7890 C9            [10]  215    ret 
                            216 
                            217 
                            218 
                            219 
   7891                     220 enemy_see_hero:
                            221 
                            222    ;; SI EL HEROE ESTÁ EN LA MISMA Y QUE EL HEROE PERO RELATIVAMENTE CERCA
                            223 
                            224    ;; Restamos uno al slow
   7891 FD 7E 09      [19]  225    ld    a,    en_slow(iy)
   7894 D6 01         [ 7]  226    sub   #1
   7896 FD 77 09      [19]  227    ld    en_slow(iy),   a
                            228 
   7899 C2 F3 78      [10]  229    jp    nz, no_mira
                            230 
...
Hexadecimal [16-Bits]
   ...
   789C FD 7E 0A      [19]  231    ld    a,    en_slowReference(iy)
   789F FD 77 09      [19]  232    ld    en_slow(iy),   a
                            233 
                            234    ;;if Enemy_y + Enemy_h - hero_y > 0   (1)
                            235 
   78A2 FD 7E 01      [19]  236    ld    a,    1(iy)
   78A5 FD 86 05      [19]  237    add   5(iy)
   78A8 DD 96 01      [19]  238    sub   1(ix)   
                            239   
   78AB F2 BB 78      [10]  240    jp    p,    comprueba_hero_y
                            241 
                            242    ;;if hero_y + hero_h - enemy_y > 0   (1)
                            243 
   78AE DD 7E 01      [19]  244    ld    a,    1(ix)
   78B1 DD 86 05      [19]  245    add   5(ix)
   78B4 FD 96 01      [19]  246    sub   1(iy)
                            247 
                            248 
   78B7 F2 CB 78      [10]  249    jp    p,    comprueba_enemy_y
   78BA C9            [10]  250    ret
                            251 
   78BB                     252    comprueba_hero_y:
                            253       ;; if hero_y + hero_w - (enemy_y + enemy_w) (1)
                            254 
   78BB DD 7E 01      [19]  255       ld    a,    1(ix)
   78BE DD 86 05      [19]  256       add   5(ix)
   78C1 FD 96 01      [19]  257       sub   1(iy)   
   78C4 FD 96 05      [19]  258       sub   5(iy)   
                            259 
   78C7 F2 DB 78      [10]  260    jp    p,    lo_veo
   78CA C9            [10]  261    ret
                            262 
   78CB                     263    comprueba_enemy_y:
                            264 
                            265    ;; if enemy_y + enemy_w - (hero_y + hero_w) (1)
                            266 
   78CB FD 7E 01      [19]  267       ld    a,    1(iy)
   78CE FD 86 05      [19]  268       add   5(iy)
   78D1 DD 96 01      [19]  269       sub   1(ix)   
   78D4 DD 96 05      [19]  270       sub   5(ix)   
                            271 
   78D7 F2 DB 78      [10]  272    jp    p,    lo_veo
   78DA C9            [10]  273    ret
                            274 
   78DB                     275    lo_veo:
                            276    ;; ver la direccion en la que va a ir el enemigo -X = 0xFF
                            277    ;;                                                X = 0x01
                            278 
   78DB DD 7E 00      [19]  279       ld    a,    0(ix)
   78DE FD 96 00      [19]  280       sub   0(iy)
                            281 
                            282 
   78E1 3E FF         [ 7]  283       ld    a,    #0xFF  
   78E3 FA E8 78      [10]  284       jp m , go_left
                            285 
...
Hexadecimal [16-Bits]
   ...
   78E6 3E 01         [ 7]  286       ld    a,    #0x01
                            287 
   78E8                     288       go_left:
   78E8 FD 77 02      [19]  289       ld    2(iy),   a   
   78EB CD 74 78      [17]  290       call  enemy_draw
                            291       ;ld    a,    10(iy)
                            292       ;cp #-1
                            293       ;jp    z,    no_draw
   78EE CD 93 77      [17]  294       call  enemy_move
   78F1                     295       no_draw:
   78F1 3E 0A         [ 7]  296       ld a, #10
   78F3                     297    no_mira: 
                            298 
   78F3 C9            [10]  299    ret
                            300 
   78F4                     301 enemy_touch_hero:
                            302 
   78F4 DD 21 61 79   [14]  303    ld    ix,    #hero_data
   78F8 CD 97 74      [17]  304    call  colision_check
                            305 
   78FB 3A 95 74      [13]  306    ld    a,    (colision)
   78FE FE 01         [ 7]  307    cp    #1
   7900 C2 3A 79      [10]  308    jp    nz, al_final        ;; Si no hay colision
                            309 
   7903 CD CE 7A      [17]  310    call  ent_background          ;; EN VERDAD LIMPIO EL HERO
   7906 3A BE 7C      [13]  311    ld    a,    (hero_y)
   7909 DD 77 01      [19]  312    ld    e_y(ix),   a
   790C 3A BD 7C      [13]  313      ld    a,    (hero_x)
   790F DD 77 00      [19]  314    ld    e_x(ix),   a
   7912 CD CE 7A      [17]  315    call  ent_background
   7915 CD 05 7B      [17]  316    call  update_draw_life
   7918 DD 7E 0A      [19]  317    ld    a,    e_life(ix)
   791B 3D            [ 4]  318    dec   a
   791C DD 77 0A      [19]  319    ld    e_life(ix), a
   791F CD 05 7B      [17]  320    call  update_draw_life
                            321 
   7922 CD BE 84      [17]  322    call  draw_obj
   7925 DD 21 C6 83   [14]  323    ld    ix,   #llave
   7929 3E 01         [ 7]  324    ld    a,    #1
   792B DD 77 07      [19]  325    ld    obj_open(ix),  a    
                            326 
   792E DD 21 CE 83   [14]  327    ld    ix,   #puerta
   7932 3E 00         [ 7]  328    ld    a,    #0
   7934 DD 77 07      [19]  329    ld    obj_open(ix),  a
                            330  
   7937 CD BE 84      [17]  331    call  draw_obj
                            332    ;call  carga_todo
                            333 
                            334 
                            335 
   793A                     336   al_final:
                            337 
   793A 3E FF         [ 7]  338    ld    a,    #-1
   793C 32 95 74      [13]  339    ld    (colision), a
                            340 
...
Hexadecimal [16-Bits]
   ...
   793F C9            [10]  341    ret
                            342 
   7940                     343 enemy_platform_check:
                            344 
   7940 3A BC 7C      [13]  345    ld    a, (n_enem)    ;; NUMERO DE PLATAFORMAS
   7943 DD 21 4F 77   [14]  346    ld    ix, #enemy_vector       ;; VECTOR DE PLATAFORMAS
                            347 
   7947                     348 bucle_enem:
                            349 
   7947 32 4E 79      [13]  350    ld    (en_plat_aux), a
                            351    
   794A CD F4 85      [17]  352    call  check_platform_enemy
                            353 
                            354 
                     01FF   355    en_plat_aux = . + 1
   794D 3E 00         [ 7]  356    ld    a, #0                     ;; VUELVO A CAMBIAR AF por AF'
   794F 01 0D 00      [10]  357    ld    bc, #k_enemy_size           ;; AUMENTO POSICION ARRAY
   7952 FD 09         [15]  358    add   iy, bc                     ;; LA CARGO EN IY
                            359 
   7954 3D            [ 4]  360    dec   a                          ;; DECREMENTO LA CANTIDAD DEL ARRAY
   7955 20 F0         [12]  361    jr    nz, bucle_enem                    ;; SI NO ES CERO BUCLE
   7957 C9            [10]  362 ret
                            363 
   7958                     364 quita_vida_enemigo:
                            365 
   7958 FD 7E 08      [19]  366    ld    a,    en_life(iy)
   795B D6 01         [ 7]  367    sub   #1
   795D FD 77 08      [19]  368    ld    en_life(iy),   a
   7960 C9            [10]  369 ret
