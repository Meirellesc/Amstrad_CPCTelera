...
Hexadecimal [16-Bits]
   ...
   8218 FF FF FF FF FF FF    22 _cpct_keyboardStatusBuffer:: .db 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
        FF FF FF FF
...
Hexadecimal [16-Bits]
                             ...
                             31 
                             32 
                             33 .globl _robot_pal    ;;uso estos colores tonos morados
                             34 
                             35 
                             36 ;;
   ...
   8222 CD 10 89      [17]   53    call  cpct_disableFirmware_asm
                             54 
   8225 0E 00         [ 7]   55    ld 	c, #0                    ;; Change video mode
   8227 CD 03 89      [17]   56    call	cpct_setVideoMode_asm    ;;
                             57    
   822A 21 C8 6A      [10]   58    ld    hl, #_robot_pal      ;; palette
   822D 11 10 00      [10]   59    ld    de, #16                  ;; 16 colors
   8230 CD D9 86      [17]   60    call  cpct_setPalette_asm      ;; set it
                             61 
   8233 21 10 14      [10]   62    ld    hl, #0x1410              ;; black border color
   8236 CD EC 86      [17]   63    call  cpct_setPALColour_asm    ;; change border color
                             64 
                             65 
                             66      
                             67 
                             68   ;; ld    a, #30
                             69    ;;call  plat_checkAll_draw
                             70 
                             71    ;;call  update_draw_life
                             72 
                             73 
                             74 ;draw_title_animation:
                             75 
                             76 
                             77    
   8239                      78 reempezar:
   8239 3E 00         [ 7]   79    ld    a,    #0
   823B 32 68 73      [13]   80    ld    (level), a
   823E CD 6A 73      [17]   81    call  cargar_nivel
   8241 DD 21 61 79   [14]   82    ld    ix,   #hero_data
   8245 3E 03         [ 7]   83    ld    a,    #0x03
   8247 DD 77 0A      [19]   84    ld    e_life(ix),    a
   824A                      85 segundaC:
...
Hexadecimal [16-Bits]
   ...
   824A CD A2 73      [17]   86    call  cargar_nivel3
   824D                      87 p_no_pulsada:
                             88 
   824D CD 54 8A      [17]   89    call cpct_scanKeyboard_asm
   8250 CD 88 86      [17]   90    call cargar_titulo
   8253 21 07 40      [10]   91     ld    hl, #Key_C 
   8256 CD CD 86      [17]   92    call  cpct_isKeyPressed_asm
   8259 28 12         [12]   93    jr    z, c_no_pulsada
   825B                      94    mamama:
   825B CD 86 73      [17]   95    call  cargar_nivel2
   825E CD 54 8A      [17]   96    call cpct_scanKeyboard_asm
   8261 21 07 40      [10]   97    ld    hl, #Key_C 
   8264 CD CD 86      [17]   98    call  cpct_isKeyPressed_asm
   8267 CA 4A 82      [10]   99    jp    z, segundaC
   826A C3 5B 82      [10]  100    jp    mamama
                            101 
                            102 
                            103 
   826D                     104    c_no_pulsada:
   826D 21 03 08      [10]  105    ld    hl, #Key_P 
   8270 CD CD 86      [17]  106    call  cpct_isKeyPressed_asm
   8273 28 D8         [12]  107    jr    z, p_no_pulsada
                            108 
   8275 3E 01         [ 7]  109    ld    a,    #1
   8277 32 68 73      [13]  110    ld    (level), a
                            111 
                            112    
   827A                     113    recargar:
   827A 3E 00         [ 7]  114    ld    a,    #0
   827C 32 69 73      [13]  115    ld    (end_level),   a
   827F CD 6A 73      [17]  116    call  cargar_nivel
   8282 3A 12 76      [13]  117    ld    a,    (munition)
   8285 CD A8 83      [17]  118    call  draw_numbers
   8288 CD BE 84      [17]  119    call  draw_obj
   828B DD 21 61 79   [14]  120    ld    ix,   #hero_data
   828F CD CE 7A      [17]  121    call  ent_background
   8292 CD 05 7B      [17]  122    call  update_draw_life
                            123    
                            124    ;; Loop forever
   8295                     125 loop:
                            126    ;;;;;;; SOLO PINTAR Y LIMPIAR SI ES NECESARIO (PLAT(OK), ENEM(OK), HERO)
                            127 
                            128    
   8295 3A 69 73      [13]  129    ld    a,    (end_level)
   8298 FE 01         [ 7]  130    cp    #1
                            131 
   829A CA 7A 82      [10]  132    jp    z, recargar                ;; SI END LEVEL = 1 carga siguiente level
                            133 
                            134 
                            135 
   829D CD 9E 84      [17]  136    call main_obj
                            137 
   82A0 DD 21 61 79   [14]  138    ld ix, #hero_data
                            139 
                            140 
...
Hexadecimal [16-Bits]
   ...
   82A4 DD 7E 0A      [19]  141    ld    a,    e_life(ix)
   82A7 FE 00         [ 7]  142    cp    #0
   82A9 C2 B8 82      [10]  143    jp    nz, no_GameOver
                            144    
                            145 
   82AC CD 5C 86      [17]  146    call cargar_GameOver
                            147    
                            148    ;ld    a,    #0
                            149    ;ld    (level), a
   82AF 3E FF         [ 7]  150    ld    a,    #0xFFFFF
   82B1                     151    fin:
                            152    
   82B1 3D            [ 4]  153    dec   a
   82B2 C2 B1 82      [10]  154    jp    nz,   fin
   82B5 C3 39 82      [10]  155    jp    reempezar
   82B8                     156    no_GameOver:
                            157    
                            158 
                            159    
                            160 
   82B8 DD 21 61 79   [14]  161    ld ix, #hero_data                      ;//////// HEROE
                            162    
   82BC CD CE 7A      [17]  163    call ent_background
   82BF CD D3 85      [17]  164    call plat_checkAll_border
   82C2 CD 93 79      [17]  165    call ent_update
   82C5 CD EB 7A      [17]  166    call ent_isJumping_or_canFall
   82C8 CD CE 7A      [17]  167    call ent_background
                            168 
   82CB 3A 0F 76      [13]  169    ld a, (hero_shot)                      ;///////// SHOT
   82CE FE FF         [ 7]  170    cp #-1
   82D0 CA DD 82      [10]  171    jp z, no_draw_shot
   82D3 DD 21 07 76   [14]  172       ld ix, #shot_data
   82D7 CD 15 77      [17]  173       call  s_background
   82DA CD 8F 76      [17]  174       call shotControl
                            175 
   82DD                     176    no_draw_shot:
                            177 
                            178 
   82DD CD F3 77      [17]  179    call enemy_interaction                 ;////////// ENEMY
                            180 
                            181 
   82E0 CD FB 88      [17]  182    call cpct_waitVSYNC_asm
                            183 
   82E3 18 B0         [12]  184    jr    loop
