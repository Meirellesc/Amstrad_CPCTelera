...
Hexadecimal [16-Bits]
                              ...
                              7 
   7368 00                    8 level:         .db #0
   7369 00                    9 end_level:     .db #0
                             10  
   736A                      11 cargar_nivel:
                             12 
   736A 21 C0 3E      [10]   13 ld hl, #_g_tileset      ;; Get the tiles
   736D CD AC 88      [17]   14 call cpct_etm_setTileset2x4_asm
                             15 
   7370 CD BE 73      [17]   16 call carga_todo
                             17     ;; Set Parameters on the stack
   7373 E5            [11]   18 push hl              ;; Push ptilemap to the stack
   7374 21 00 C0      [10]   19 ld   hl, #0xC000 ;; HL = Pointer to video memory location where tilemap is drawn
   7377 E5            [11]   20 push hl              ;; Push pvideomem to the stack
                             21 ;; Set Paramters on registers
   7378 3E 28         [ 7]   22 ld    a, #40           ;; A = map_width
   737A 06 00         [ 7]   23 ld    b, #0x00          ;; B = x tile-coordinate
   737C 0E 00         [ 7]   24 ld    c, #0x00          ;; C = y tile-coordinate
   737E 16 32         [ 7]   25 ld    d, #0x32          ;; H = height in tiles of the tile-box
   7380 1E 28         [ 7]   26 ld    e, #0x28          ;; L =  width in tiles of the tile-box
   7382 CD 20 88      [17]   27 call  cpct_etm_drawTileBox2x4_asm ;; Call the function
                             28 
   7385 C9            [10]   29 ret
                             30 
   7386                      31 cargar_nivel2:
                             32 
   7386 21 C0 3E      [10]   33 ld hl, #_g_tileset      ;; Get the tiles
   7389 CD AC 88      [17]   34 call cpct_etm_setTileset2x4_asm
                             35 
   738C 21 10 08      [10]   36 ld  hl, #_controls
                             37     ;; Set Parameters on the stack
   738F E5            [11]   38 push hl              ;; Push ptilemap to the stack
   7390 21 00 C0      [10]   39 ld   hl, #0xC000 ;; HL = Pointer to video memory location where tilemap is drawn
   7393 E5            [11]   40 push hl              ;; Push pvideomem to the stack
                             41 ;; Set Paramters on registers
   7394 3E 28         [ 7]   42 ld    a, #40           ;; A = map_width
   7396 06 00         [ 7]   43 ld    b, #0x00          ;; B = x tile-coordinate
   7398 0E 00         [ 7]   44 ld    c, #0x00          ;; C = y tile-coordinate
   739A 16 32         [ 7]   45 ld    d, #0x32          ;; H = height in tiles of the tile-box
   739C 1E 28         [ 7]   46 ld    e, #0x28          ;; L =  width in tiles of the tile-box
   739E CD 20 88      [17]   47 call  cpct_etm_drawTileBox2x4_asm ;; Call the function
                             48 
   73A1 C9            [10]   49 ret
   73A2                      50 cargar_nivel3:
                             51 
   73A2 21 C0 3E      [10]   52 ld hl, #_g_tileset      ;; Get the tiles
   73A5 CD AC 88      [17]   53 call cpct_etm_setTileset2x4_asm
                             54 
   73A8 21 40 00      [10]   55 ld  hl, #_fin
                             56     ;; Set Parameters on the stack
   73AB E5            [11]   57 push hl              ;; Push ptilemap to the stack
   73AC 21 00 C0      [10]   58 ld   hl, #0xC000 ;; HL = Pointer to video memory location where tilemap is drawn
   73AF E5            [11]   59 push hl              ;; Push pvideomem to the stack
                             60 ;; Set Paramters on registers
   73B0 3E 28         [ 7]   61 ld    a, #40           ;; A = map_width
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 55.
Hexadecimal [16-Bits]



   73B2 06 00         [ 7]   62 ld    b, #0x00          ;; B = x tile-coordinate
   73B4 0E 00         [ 7]   63 ld    c, #0x00          ;; C = y tile-coordinate
   73B6 16 32         [ 7]   64 ld    d, #0x32          ;; H = height in tiles of the tile-box
   73B8 1E 28         [ 7]   65 ld    e, #0x28          ;; L =  width in tiles of the tile-box
   73BA CD 20 88      [17]   66 call  cpct_etm_drawTileBox2x4_asm ;; Call the function
                             67 
   73BD C9            [10]   68 ret
                             69 
   73BE                      70 carga_todo:
   73BE 3A 68 73      [13]   71 	ld 	a,	(level)
   73C1 FE 00         [ 7]   72 	cp 	#0
   73C3 CA FE 73      [10]   73 	jp 	z, 	elFin
   73C6 3A 68 73      [13]   74 	ld 	a, 	(level)
   73C9 FE 01         [ 7]   75 	cp 	#1
   73CB CA 02 74      [10]   76 	jp 	z, carga_level_0
   73CE 3A 68 73      [13]   77 	ld 	a, 	(level)
   73D1 FE 02         [ 7]   78 	cp 	#2
   73D3 CA 09 74      [10]   79 	jp 	z, carga_level_1
   73D6 3A 68 73      [13]   80 	ld 	a, 	(level)
   73D9 FE 03         [ 7]   81 	cp 	#3
   73DB CA 10 74      [10]   82 	jp 	z, carga_level_2
   73DE 3A 68 73      [13]   83 	ld 	a, 	(level)
   73E1 FE 04         [ 7]   84 	cp 	#4
   73E3 CA 17 74      [10]   85 	jp 	z, carga_level_3
   73E6 3A 68 73      [13]   86 	ld 	a, 	(level)
   73E9 FE 05         [ 7]   87 	cp 	#5
   73EB CA 1E 74      [10]   88 	jp 	z, carga_level_4
   73EE 3A 68 73      [13]   89 	ld 	a, 	(level)
   73F1 FE 06         [ 7]   90 	cp 	#6
   73F3 CA 25 74      [10]   91 	jp 	z, carga_level_5
   73F6 3A 68 73      [13]   92 	ld 	a, 	(level)
   73F9 FE 07         [ 7]   93 	cp 	#7
   73FB CA 2C 74      [10]   94 	jp 	z, carga_level_6
                             95 	
   73FE                      96 	elFin:
   73FE 21 40 00      [10]   97 	ld   hl, #_fin   ;; HL = pointer to the tilemap
   7401 C9            [10]   98 	ret
   7402                      99 	carga_level_0:
   7402 CD BF 7C      [17]  100 	call 	load_level0
   7405 21 F0 36      [10]  101 	ld   hl, #_level0   ;; HL = pointer to the tilemap
   7408 C9            [10]  102 	ret
   7409                     103 	carga_level_1:
   7409 CD 61 7D      [17]  104 	call 	load_level1
   740C 21 20 2F      [10]  105 	ld   hl, #_level1   ;; HL = pointer to the tilemap
   740F C9            [10]  106 	ret
   7410                     107 	carga_level_2:
   7410 21 50 27      [10]  108 	ld   hl, #_level2   ;; HL = pointer to the tilemap
   7413 CD F7 7D      [17]  109 	call 	load_level2
   7416 C9            [10]  110 	ret
   7417                     111 	carga_level_3:
   7417 21 20 2F      [10]  112 	ld   hl, #_level1   ;; HL = pointer to the tilemap
   741A CD 97 7E      [17]  113 	call 	load_level3
   741D C9            [10]  114 	ret
   741E                     115 	carga_level_4:
   741E 21 E0 0F      [10]  116 	ld   hl, #_level8   ;; HL = pointer to the tilemap
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   7421 CD 3A 7F      [17]  117 	call 	load_level8
   7424 C9            [10]  118 	ret
   7425                     119 	carga_level_5:
   7425 21 B0 17      [10]  120 	ld   hl, #_level9   ;; HL = pointer to the tilemap
   7428 CD 6D 80      [17]  121 	call 	load_level9
   742B C9            [10]  122 	ret
   742C                     123 	carga_level_6:
   742C 21 80 1F      [10]  124 	ld   hl, #_level10   ;; HL = pointer to the tilemap
   742F CD 3A 81      [17]  125 	call 	load_level10
   7432 C9            [10]  126 	ret
                            127 	
   7433 C9            [10]  128 ret
                            129 
   7434                     130 carga_fondos:
   7434 3A 68 73      [13]  131 	ld 	a,	(level)
   7437 FE 00         [ 7]  132 	cp 	#0
   7439 CA 74 74      [10]  133 	jp 	z, 	elFines
   743C 3A 68 73      [13]  134 	ld 	a, 	(level)
   743F FE 01         [ 7]  135 	cp 	#1
   7441 CA 78 74      [10]  136 	jp 	z, cargalevel_0
   7444 3A 68 73      [13]  137 	ld 	a, 	(level)
   7447 FE 02         [ 7]  138 	cp 	#2
   7449 CA 7C 74      [10]  139 	jp 	z, cargalevel_1
   744C 3A 68 73      [13]  140 	ld 	a, 	(level)
   744F FE 03         [ 7]  141 	cp 	#3
   7451 CA 80 74      [10]  142 	jp 	z, cargalevel_2
   7454 3A 68 73      [13]  143 	ld 	a, 	(level)
   7457 FE 04         [ 7]  144 	cp 	#4
   7459 CA 84 74      [10]  145 	jp 	z, cargalevel_3
   745C 3A 68 73      [13]  146 	ld 	a, 	(level)
   745F FE 05         [ 7]  147 	cp 	#5
   7461 CA 88 74      [10]  148 	jp 	z, cargalevel_4
   7464 3A 68 73      [13]  149 	ld 	a, 	(level)
   7467 FE 06         [ 7]  150 	cp 	#6
   7469 CA 8C 74      [10]  151 	jp 	z, cargalevel_5
   746C 3A 68 73      [13]  152 	ld 	a, 	(level)
   746F FE 07         [ 7]  153 	cp 	#7
   7471 CA 90 74      [10]  154 	jp 	z, cargalevel_6
                            155 	
                            156 
   7474                     157 	elFines:
   7474 21 40 00      [10]  158 	ld   hl, #_fin   ;; HL = pointer to the tilemap
   7477 C9            [10]  159 	ret
   7478                     160 	cargalevel_0:
   7478 21 F0 36      [10]  161 	ld   hl, #_level0   ;; HL = pointer to the tilemap
   747B C9            [10]  162 	ret
   747C                     163 	cargalevel_1:
   747C 21 20 2F      [10]  164 	ld   hl, #_level1   ;; HL = pointer to the tilemap
                            165 
   747F C9            [10]  166 	ret
   7480                     167 	cargalevel_2:
   7480 21 50 27      [10]  168 	ld   hl, #_level2   ;; HL = pointer to the tilemap
                            169 
   7483 C9            [10]  170 	ret
   7484                     171 	cargalevel_3:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



   7484 21 20 2F      [10]  172 	ld   hl, #_level1   ;; HL = pointer to the tilemap
                            173 
   7487 C9            [10]  174 	ret
   7488                     175 	cargalevel_4:
   7488 21 E0 0F      [10]  176 	ld   hl, #_level8   ;; HL = pointer to the tilemap
                            177 
   748B C9            [10]  178 	ret
   748C                     179 	cargalevel_5:
   748C 21 B0 17      [10]  180 	ld   hl, #_level9   ;; HL = pointer to the tilemap
                            181 
   748F C9            [10]  182 	ret
   7490                     183 	cargalevel_6:
   7490 21 80 1F      [10]  184 	ld   hl, #_level10   ;; HL = pointer to the tilemap
                            185 
   7493 C9            [10]  186 	ret
                            187 
                            188 	
