...
Hexadecimal [16-Bits]
                              ...
                              7 
                              8 
   75E1                       9 ShotTableRight:
   75E1 01 01 01             10    .db   #1, #1, #1
   75E4 01 01 01             11    .db   #1, #1, #1
   75E7 01 01 01             12    .db   #1, #1, #1
   75EA 01 01 01             13    .db   #1, #1, #1
   75ED 01 01 01 00 00       14    .db   #1, #1, #1, #00, #00
   75F2 00                   15    .db   #00
   75F3 80                   16    .db   #0x80
                             17 
   75F4                      18 ShotTableLeft:
   75F4 FF FF FF             19    .db   #-1, #-1, #-1
   75F7 FF FF FF             20    .db   #-1, #-1, #-1
   75FA FF FF FF             21    .db   #-1, #-1, #-1
   75FD FF FF FF             22    .db   #-1, #-1, #-1
   7600 FF FF FF 00 00       23    .db   #-1, #-1, #-1, #00, #00
   7605 00                   24    .db   #00
   7606 80                   25    .db   #0x80
                             26 
   7607                      27 DefineDisparo	shot_data, 0x00,0x00, 0x00, 0x00, 0x04, 0x06, _disparo_sp_0
   0026                       1 shot_data:
   7607 00 00                 2    .db   0x00, 0x00       ;;X, Y
   7609 00 00                 3    .db	 0x00, 0x00	  ;;vX, vY
   760B 04 06                 4    .db	 0x04, 0x06		  ;;W, H
   760D D4 40                 5    .dw	 _disparo_sp_0		  ;;Color
                              6 
                             28 
   760F FF                   29 hero_shot:	.db #-1
   7610 01                   30 shot_direction:            .db	#1			;; Direction: -X = 0 or X = 1
   7611 01                   31 final_direction:          .db #1
   7612 09                   32 munition:	           .db #9
   7613 64                   33 pos_bala_x:             .db#100
   7614 64                   34 pos_bala_y:             .db#100
                             35 
                             36 
                             37 
   7615                      38 startShot:
                             39    
   7615 3A 12 76      [13]   40    ld    a ,   (munition)
   7618 FE 00         [ 7]   41    cp #0
   761A CA 8E 76      [10]   42    jp    z, no_munition   
   761D 3A 0F 76      [13]   43    ld    a, (hero_shot)    ;; Acceder a hero_jump
   7620 FE FF         [ 7]   44    cp    #-1               ;; check if shot is active
   7622 C0            [11]   45    ret   nz                ;;
   7623 DD 21 07 76   [14]   46    ld    ix,   #shot_data
                             47 
   7627 3E 00         [ 7]   48    ld    a, #0
   7629 32 0F 76      [13]   49    ld    (hero_shot), a
   762C FD 21 61 79   [14]   50    ld	iy,	#hero_data
   7630 DD 21 07 76   [14]   51    ld	ix, #shot_data
                             52 
                             53    
                             54 
   7634 3A 10 76      [13]   55    ld	a,	(shot_direction)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 55.
Hexadecimal [16-Bits]



   7637 32 11 76      [13]   56    ld	(final_direction), a
   763A FE 00         [ 7]   57    cp #0
   763C CA 65 76      [10]   58    jp 	z, shot_left
   763F FD 7E 01      [19]   59 	   ld	a,	e_y(iy)
   7642 FD 86 04      [19]   60 	   add	e_w(iy)
   7645 DD 77 01      [19]   61 	   ld	s_y(ix), a
                             62 
   7648 FD 7E 00      [19]   63 	   ld 	a,	e_x(iy)
   764B FD 86 04      [19]   64 	   add	e_w(iy)
   764E DD 77 00      [19]   65 	   ld	s_x(ix), a
                             66       
                             67       ; SI SALTA NO LIMPIO
   7651 3A 79 79      [13]   68       ld    a, (hero_jump)
   7654 FE FF         [ 7]   69       cp    #-1
   7656 CA 8B 76      [10]   70 	   jp   z,    limpio_el_primer_tiro
                             71 
   7659 DD 21 61 79   [14]   72       ld    ix,   #hero_data
   765D CD CE 7A      [17]   73       call  ent_background
   7660 DD 21 07 76   [14]   74       ld    ix,   #shot_data
   7664 C9            [10]   75       ret
                             76 
   7665                      77    shot_left:
                             78 
   7665 FD 7E 01      [19]   79    	   ld	a,	e_y(iy)
   7668 FD 86 04      [19]   80 	   add	e_w(iy)
   766B DD 77 01      [19]   81 	   ld	s_y(ix), a
                             82 
   766E FD 7E 00      [19]   83 	   ld 	a,	e_x(iy)
   7671 FD 96 04      [19]   84 	   sub	s_w(iy)
   7674 DD 77 00      [19]   85 	   ld	s_x(ix), a
   7677 3A 79 79      [13]   86       ld    a, (hero_jump)
   767A FE FF         [ 7]   87       cp    #-1
                             88 
   767C CA 8B 76      [10]   89       jp   z,    limpio_el_primer_tiro
   767F DD 21 61 79   [14]   90       ld    ix,   #hero_data
   7683 CD CE 7A      [17]   91       call  ent_background
   7686 DD 21 07 76   [14]   92       ld    ix,   #shot_data
   768A C9            [10]   93       ret
   768B                      94       limpio_el_primer_tiro:
   768B CD 15 77      [17]   95       call s_background
   768E                      96    no_munition:
   768E C9            [10]   97    ret
                             98 
   768F                      99 shotControl:
                            100    
                            101    ;; check if we are jumping right now
   768F 3A 0F 76      [13]  102    ld    a, (hero_shot)          ;; A = hero_shot status
   7692 FE FF         [ 7]  103    cp    #-1                     ;; A == -1? (-1 es que no salta)
   7694 C8            [11]  104    ret   z                       ;; 
                            105 
                            106    ;; get shot value
                            107 
   7695 21 D4 40      [10]  108    ld    hl,   #_disparo_sp_0
   7698 DD 75 06      [19]  109    ld    s_sp_l(ix),    l
   769B DD 74 07      [19]  110    ld    s_sp_h(ix),    h  
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 56.
Hexadecimal [16-Bits]



   769E 21 F4 75      [10]  111    ld    hl, #ShotTableLeft         ;; HL points to start of shot
   76A1 3A 11 76      [13]  112    ld 	 a, (final_direction)
   76A4 FE 00         [ 7]  113    cp 	 #0
   76A6 CA B5 76      [10]  114    jp 	 z,	continue_shot
   76A9 21 EC 40      [10]  115       ld    hl,   #_disparo_sp_1
   76AC DD 75 06      [19]  116       ld    s_sp_l(ix),    l
   76AF DD 74 07      [19]  117       ld    s_sp_h(ix),    h     
   76B2 21 E1 75      [10]  118 		ld    hl, #ShotTableRight         ;; HL points to start of shot 
                            119          	
                            120 
   76B5                     121 continue_shot: 
   76B5 3A 0F 76      [13]  122    ld    a, (hero_shot)          ;; A = hero_shot status
   76B8 4F            [ 4]  123    ld    c, a                    ;;
   76B9 06 00         [ 7]  124    ld    b, #0                   ;; BC = A(offset)
   76BB 09            [11]  125    add   hl, bc                  ;; HL += BC
                            126 
                            127 
                            128    ;; check end of jumping
   76BC 7E            [ 7]  129    ld    a, (hl)                 ;; A = shot movement
   76BD FE 80         [ 7]  130    cp    #0x80                   ;; shot value == 0x80? end of shot
   76BF 28 3A         [12]  131    jr    z, end_shot          	 ;; If 0x80, end of shot
                            132 
                            133    ;; do shot movement
   76C1 47            [ 4]  134    ld    b, a                    ;; B = shot movement
   76C2 DD 7E 00      [19]  135    ld    a, s_x(ix)              ;; A = e_x
   76C5 80            [ 4]  136    add   b                       ;; A += B (add shot)
                            137 
   76C6 DD 77 00      [19]  138    ld    s_x(ix), a              ;; update e_x value
                            139 
   76C9 DD 7E 00      [19]  140    ld    a,    s_x(ix)
   76CC FE 4C         [ 7]  141    cp    #0x4C
   76CE CA DE 76      [10]  142    jp    z, se_sale
   76D1 FA DE 76      [10]  143    jp    m, se_sale
                            144 
   76D4 DD 7E 00      [19]  145    ld    a,    s_x(ix)
   76D7 90            [ 4]  146    sub   b
   76D8 DD 77 00      [19]  147    ld    s_x(ix), a 
   76DB C3 FB 76      [10]  148    jp    end_shot
                            149    
   76DE                     150    se_sale:
   76DE DD 7E 00      [19]  151    ld    a,    s_x(ix)
   76E1 FE 00         [ 7]  152    cp    #0x00
   76E3 F2 F0 76      [10]  153    jp    p, sigue_disparo
                            154    
   76E6 DD 7E 00      [19]  155    ld    a,    s_x(ix)
   76E9 90            [ 4]  156    sub   b
   76EA DD 77 00      [19]  157    ld    s_x(ix), a 
   76ED C3 FB 76      [10]  158    jp    end_shot
   76F0                     159    sigue_disparo:
                            160    ;; increment hero_shot index
   76F0 3A 0F 76      [13]  161    ld    a, (hero_shot)          ;; A = hero_shot
   76F3 3C            [ 4]  162    inc   a                       ;;
   76F4 32 0F 76      [13]  163    ld    (hero_shot), a          ;; hero_shot++
                            164 
   76F7 CD 15 77      [17]  165    call s_background
...
Hexadecimal [16-Bits]
   ...
   76FA C9            [10]  167    ret
                            168 
                            169    ;;put -1 in the shot index when shot ended
   76FB                     170 end_shot:
                            171 
   76FB 3E FF         [ 7]  172 	ld    a, #-1               ;;
   76FD 32 0F 76      [13]  173    ld    (hero_shot), a       ;; hero_shot=-1
                            174    ;call s_background
   7700 3A 12 76      [13]  175    ld    a,    (munition)
   7703 CD A8 83      [17]  176    call draw_numbers
   7706 3A 12 76      [13]  177    ld    a, (munition)
   7709 D6 01         [ 7]  178    sub   #1
   770B 32 12 76      [13]  179    ld    (munition), a
   770E 3A 12 76      [13]  180    ld    a,    (munition)
   7711 CD A8 83      [17]  181    call draw_numbers
                            182 
   7714 C9            [10]  183 	ret
                            184 
                            185 
   7715                     186 s_background:
   7715 11 00 C0      [10]  187 ld    de, #0xC000         ;; Comienzo de memoria de video
   7718 DD 4E 00      [19]  188   ld    c, s_x(ix)          ;; Entidad X
   771B DD 46 01      [19]  189   ld    b, s_y(ix)          ;; Entidad Y
   771E CD 38 8A      [17]  190   call  cpct_getScreenPtr_asm  ;; Posicionar en pantalla
                            191 
                            192   ;;;HL -> Memoria de video
                            193 
   7721 EB            [ 4]  194   ex    de, hl         ;; Cambio lo de HL a DE
   7722 DD 6E 06      [19]  195   ld    l, s_sp_l(ix)
   7725 DD 66 07      [19]  196   ld    h, s_sp_h(ix)
                            197   ;;;ld    hl, #_hero_sp_0  
   7728 DD 4E 05      [19]  198   ld    c,  s_h(ix)     ;; Alto
   772B DD 46 04      [19]  199   ld    b,  s_w(ix)     ;; Ancho
                            200 
                            201 
   772E CD ED 89      [17]  202    call cpct_drawSpriteBlended_asm
   7731 C9            [10]  203 ret
                            204 
                            205   
                            206 
                            207 
   7732                     208 s_draw:
   7732 11 00 C0      [10]  209    ld    de, #0xC000         ;; Comienzo de memoria de video
   7735 DD 4E 00      [19]  210    ld    c, e_x(ix)          ;; Entidad X
   7738 DD 46 01      [19]  211    ld    b, e_y(ix)          ;; Entidad Y
   773B CD 38 8A      [17]  212    call  cpct_getScreenPtr_asm  ;; Posicionar en pantalla
                            213 
                            214    ;;HL -> Memoria de video
                            215 
   773E EB            [ 4]  216    ex    de, hl         ;; Cambio lo de HL a DE
   773F DD 6E 06      [19]  217    ld    l, e_sp_l(ix)
   7742 DD 66 07      [19]  218    ld    h, e_sp_h(ix)
                            219    ;;ld    hl, #_hero_sp_0  
   7745 DD 46 05      [19]  220    ld    b, e_h(ix)     ;; Alto
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 58.
Hexadecimal [16-Bits]



   7748 DD 4E 04      [19]  221    ld    c, e_w(ix)     ;; Ancho
                            222  
   774B CD 80 87      [17]  223    call cpct_drawSprite_asm
                            224 
   774E C9            [10]  225    ret 
