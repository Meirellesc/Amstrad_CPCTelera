...
Hexadecimal [16-Bits]
                              ...
                              5 
                              6 .globl _title_sp
                              7 .globl _fondotitulo_sp
                              8 
   8615                       9 DefineTitle titulito, 0x07, 0x10, 0x00, 0x00, 0x3C, 0x32, _title_sp
   0000                       1 titulito:
   8615 07 10                 2    .db   0x07, 0x10       ;;X, Y
   8617 00 00                 3    .db   0x00, 0x00     ;;VX, VY
   8619 3C 32                 4    .db   0x3C, 0x32       ;;W, H
   861B A0 59                 5    .dw   _title_sp      ;;Puntero al sprite
                     0008     6    titulito_size = . - titulito
                             10 
   861D D8 4D                11 sprite_fondo:     .dw  _fondotitulo_sp      ;;variable q pinta negro el fondo
                             12 
   861F                      13 title_draw:
                             14 
   861F 11 00 C0      [10]   15 	ld    de, #0xC000         ;; Comienzo de memoria de video
   8622 DD 4E 00      [19]   16    	ld    c, t_x(ix)          ;; Entidad X
   8625 DD 46 01      [19]   17    	ld    b, t_y(ix)          ;; Entidad Y
   8628 CD 38 8A      [17]   18   	call  cpct_getScreenPtr_asm  ;; Posicionar en pantalla
                             19 
                             20    ;;HL -> Memoria de video
                             21 
   862B EB            [ 4]   22    	ex    de, hl         ;; Cambio lo de HL a DE
   862C DD 6E 06      [19]   23    	ld    l, t_sp_l(ix)
   862F DD 66 07      [19]   24    	ld    h, t_sp_h(ix) 
   8632 DD 46 05      [19]   25    	ld    b, t_h(ix)     ;; Alto
   8635 DD 4E 04      [19]   26    	ld    c, t_w(ix)     ;; Ancho
                             27  
   8638 CD 80 87      [17]   28    	call cpct_drawSprite_asm
                             29    
   863B C9            [10]   30    ret
                             31 
   863C                      32 title_clear:
   863C 21 D8 4D      [10]   33 	ld   hl, #_fondotitulo_sp       ;; El color lo cambio por fondo
   863F DD 75 06      [19]   34    	ld    t_sp_l(ix), l
   8642 DD 74 07      [19]   35    	ld    t_sp_h(ix), h
   8645 CD 1F 86      [17]   36    	call  title_draw           ;; Le digo que dibuje fondo para que borrar 
                             37    
   8648 21 A0 59      [10]   38     ld   hl, #_title_sp 
   864B DD 75 06      [19]   39     ld    t_sp_l(ix), l
   864E DD 74 07      [19]   40     ld    t_sp_h(ix), h
                             41   
   8651 C9            [10]   42     ret
                             43 
   8652                      44 title_animation:
   8652 DD 7E 01      [19]   45 	ld 	a, t_y(ix)
   8655 DD 86 01      [19]   46 	add t_y(ix)
   8658 DD 77 01      [19]   47 	ld 	t_y(ix), a
                             48 
   865B C9            [10]   49 	ret
                             50 
   865C                      51 cargar_GameOver:
   865C DD 21 15 86   [14]   52     ld  ix, #titulito
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 52.
Hexadecimal [16-Bits]



   8660 21 F8 4A      [10]   53     ld   hl, #_GameOver_sp
   8663 DD 75 06      [19]   54     ld    t_sp_l(ix), l
   8666 DD 74 07      [19]   55     ld    t_sp_h(ix), h
                             56 
   8669 3E 1A         [ 7]   57     ld  a, #0x1A      ;; HAY QUE CENTRARLO
   866B DD 77 00      [19]   58     ld  t_x(ix),  a
   866E 3E 30         [ 7]   59     ld  a, #0x30
   8670 DD 77 01      [19]   60     ld  t_y(ix),  a
   8673 3E 1E         [ 7]   61     ld  a, #0x1E
   8675 DD 77 04      [19]   62     ld  t_w(ix),  a
   8678 3E 18         [ 7]   63     ld  a, #0x18
   867A DD 77 05      [19]   64     ld  t_h(ix),  a
                             65 
   867D CD 1F 86      [17]   66     call  title_draw
                             67 
                             68 
   8680 3E AA         [ 7]   69     ld    a, #0xAAA
   8682                      70     go_here:
   8682 3D            [ 4]   71     dec   a
   8683 76            [ 4]   72     halt
   8684 C2 82 86      [10]   73     jp    nz, go_here
   8687 C9            [10]   74 ret
                             75 
   8688                      76 cargar_titulo:
   8688 DD 21 15 86   [14]   77     ld  ix,   #titulito
   868C 21 A0 59      [10]   78     ld  hl,   #_title_sp
   868F DD 75 06      [19]   79     ld    t_sp_l(ix), l
   8692 DD 74 07      [19]   80     ld    t_sp_h(ix), h
   8695 3E 07         [ 7]   81     ld  a, #0x07      
   8697 DD 77 00      [19]   82     ld  t_x(ix),  a
   869A 3E 00         [ 7]   83     ld  a, #0x00
   869C DD 77 01      [19]   84     ld  t_y(ix),  a
   869F 3E 3C         [ 7]   85     ld  a, #0x3C
   86A1 DD 77 04      [19]   86     ld  t_w(ix),  a
   86A4 3E 32         [ 7]   87     ld  a, #0x32
   86A6 DD 77 05      [19]   88     ld  t_h(ix),  a
   86A9 CD 1F 86      [17]   89     call  title_draw
                             90 
   86AC 21 50 42      [10]   91     ld  hl,   #_eleccion_sp
   86AF DD 75 06      [19]   92     ld    t_sp_l(ix), l
   86B2 DD 74 07      [19]   93     ld    t_sp_h(ix), h
   86B5 3E 0A         [ 7]   94     ld  a, #0x0A      ;; HAY QUE CENTRARLO
   86B7 DD 77 00      [19]   95     ld  t_x(ix),  a
   86BA 3E 80         [ 7]   96     ld  a, #0x80
   86BC DD 77 01      [19]   97     ld  t_y(ix),  a
   86BF 3E 32         [ 7]   98     ld  a, #0x32
   86C1 DD 77 04      [19]   99     ld  t_w(ix),  a
   86C4 3E 2C         [ 7]  100     ld  a, #0x2C
   86C6 DD 77 05      [19]  101     ld  t_h(ix),  a
   86C9 CD 1F 86      [17]  102     call  title_draw
   86CC C9            [10]  103 ret
