...
$(eval $(call IMG2SPRITES,assets/tiles.png,0,g,4,4,$(PALETTE),tileset,src/,hwpalette))
$(eval $(call IMG2SPRITES,assets/hero.png,0,g,16,27,$(PALETTE),,src/))
$(eval $(call IMG2SPRITES,assets/retropolis.png,0,g,80,66,$(PALETTE),,src/))